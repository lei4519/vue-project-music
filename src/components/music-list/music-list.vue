<template>
  <div class="music-list" ref="singerDetail">
    ...
    <div class="cover" ref="cover" :style="bgStyle" :class="{'fixed': !isPlayShow}">
      <div class="random-play">
        <div class="play" @click="randomPlay({list: songs})" v-show="isPlayShow&&isSongShow">
          <i class="icon-play"></i>
    ...
    >
      <div class="song-list-wrapper">
        <song-list @select="selectItem" :songs="songs" :isRank="isRank"/>
      </div>
    </scroll>
