...
if(isDev) {
  ...
  // 需要预渲染的路由
  const prerenderRoutes = ['/recommend']
  // 是否使用gzip
  ...
  config = {
    ...
    outputDir: DIST_ROOT + PUBLIC_PATH, // prerendner会借助一个express服务器来预渲染，改变baseUrl后要保证这个模拟服务器能够找到所需的资源
    assetsDir: 'static',
    productionSourceMap: false,
      ...
      if (process.env.NODE_ENV === 'production') {
        ...
        productionPrerender && myConfig.plugins.push(
          new PrerenderSPAPlugin({
            ...
            outputDir: path.resolve(__dirname, DIST_ROOT + PUBLIC_PATH),
            indexPath: path.resolve(__dirname, DIST_ROOT + PUBLIC_PATH + 'index.html'),
